...
on_screen = {
    ...
    "absol": [False, False], # create run template from gui input
...
def sweep_screen(confidence=0.9):
    screenshot = pyautogui.screenshot(region=(1170, 184, 718, 567))
...
#         time.sleep(0.5)
#         pause_event.wait()
#         # check if image exists, populate on_screen with true/false
#         sweep_screen()
...
#                     continue
#                 elif not active and name == "catch_synch":
#                     continue
#                 else:
#                     isolate_func(run)
def watch_screen():
